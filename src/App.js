...
<div className='input'>
<br/>
<TextField id="outlined-basic" label=" Amount" variant="outlined" onChange={e=>setPrinciple(e.target.value)}value={principle} />
<br/>
<TextField id="outlined-basic" label=" Interest" variant="outlined" onChange={e=>setRate(e.target.value)}value={rate} />
<br/>
...
<br/>
<Button id='reset' variant="outlined" onClick={Resetall}>Reset</Button>
</div>
